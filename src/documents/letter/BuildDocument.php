...
\begin{flushright}
<?php if ($conf["Signature"]["Identity"]) { ?>
    <?=$conf["Signature"]["Identity"]; ?>
<?php } ?>

<?php if ($conf["Signature"]["Role"]) { ?>
    <?=$conf["Signature"]["Role"]; ?>
<?php } ?>

<?php if (isset($conf["Signature"]["Signature"])) { ?>
    [@Image;<?=$conf["Signature"]["Signature"]; ?>;width=4cm;height=2cm]
<?php } ?>
\end{flushright}
